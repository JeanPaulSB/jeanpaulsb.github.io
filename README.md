...
I have been playing around with Isaac Sim since version 4.5.0, and I have noticed a lot of interesting changes in the performance and stability of the simulator, which highlights the effort and work that developers are putting into it.
